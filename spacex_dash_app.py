...
def get_scatter_chart(entered_site, entered_payload):
    filtered_df = spacex_df
    if entered_site == 'ALL':
        condition1 = filtered_df["Payload Mass (kg)"] >= entered_payload[0]
        filtered_df1 = filtered_df[condition1]
        condition2 = filtered_df1["Payload Mass (kg)"] <= entered_payload[1]
        ...
        condition2 = filtered_df1["Payload Mass (kg)"] <= entered_payload[1]
        filtered_df2 = filtered_df1[condition2]
        condition3 = filtered_df2["Launch Site"] == entered_site
        filtered_df3 = filtered_df2[condition3]
